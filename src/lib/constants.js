...
export const ITEMS = [
    ...
    { id: 'reg_arm', name: 'Braço Mecânico', type: 'equip', slot: 'weapon', price: 15000, effect: { atk: 500 }, maxUses: 10, icon: 'zap', color: 'text-yellow-500', desc: "Arma suprema. 10 usos antes de quebrar." },
